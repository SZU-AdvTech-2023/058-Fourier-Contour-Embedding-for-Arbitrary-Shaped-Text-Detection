...
from mmocr_.models.textdet.heads import BaseTextDetHead
...
class FCEHead(BaseTextDetHead):
    ...
    def forward(self,
        ...
        #     print('len of inputs', inputs[i].shape)
        
        cls_res, reg_res = multi_apply(self.forward_single, inputs)
        level_num = len(cls_res)
        # print('len of cls_res', len(cls_res))
    ...
    def forward_single(self, x: torch.Tensor) -> torch.Tensor:
        ...
        print('len of cls_predict', cls_predict.shape)
        print('len of reg_predict', reg_predict.shape)

        # print('len of cls_predict', len(cls_predict))
        # print('len of cls_predict', cls_predict)
