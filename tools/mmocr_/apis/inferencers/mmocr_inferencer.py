...
from mmocr_.registry import VISUALIZERS
from mmocr_.structures import TextSpottingDataSample
from mmocr_.utils import ConfigType, bbox2poly, crop_img, poly2bbox
