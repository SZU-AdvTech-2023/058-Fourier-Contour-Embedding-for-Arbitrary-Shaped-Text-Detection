...
from mmocr_.evaluation.functional import compute_hmean
from mmocr_.registry import METRICS
from mmocr_.utils import poly_intersection, poly_iou, polys2shapely
